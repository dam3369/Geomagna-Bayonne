...
gpsText.innerHTML = "<br /><h1>Retour Porte de Mousserolles.</h1>";
bulle_plate.innerHTML = r+" m&egrave;tres</span>";

if(r<"20"){
	document.location.href="../validate.php?validated=17"
}
};

gpsText.innerHTML = "<h1>17&egrave;me Epreuve !</h1><img src='../../img/loading.gif'>";
