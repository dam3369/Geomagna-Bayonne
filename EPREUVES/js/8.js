...
function getGPS() {
	...
	function showGPS(position) {
		...
		gpsText.innerHTML = "<h1>Tous les ans,<br />je suis le Roi des<br />F&ecirc;tes de Bayonne</h1>"
		bulle_plate.innerHTML = r+" m&egrave;tres</span>";

		if(r<"20"){
			document.location.href="../validate.php?validated=8"
		}

};

gpsText.innerHTML = "<h1>8&egrave;me Epreuve !</h1><img src='../../img/loading.gif'>";
